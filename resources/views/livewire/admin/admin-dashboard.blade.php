<div class="bg-gray-600">
    ...
    <div class="xl:px-12">
        ...
        <div class="flex flex-wrap p-3 pt-10 rounded-lg items-stretch h-full">
            ...
            <div class="w-full xl:w-2/5 pl-3 pr-3 pt-4 flex flex-col">
                <div class="bg-gray-800 rounded-lg shadow-md flex-grow overflow-hidden">
            ...
            <div class="w-full xl:w-2/5 pl-3 pr-3 pt-4 flex flex-col">
                <div class="bg-gray-800 rounded-lg shadow-md flex-grow overflow-hidden flex flex-col">
                    <!-- Header -->
                    ...
                    <!-- Content Section -->
                    <div class="flex-grow flex flex-col items-center justify-between px-10 py-8 overflow-auto">
                        <!-- User Image -->
                        <div class="w-24 mb-5 rounded-full overflow-hidden border-4 border-blue-500">
                        ...
                        <div class="w-full space-y-3">
                            ...
                            <div class="flex items-center justify-between text-white">
                                ...
                                <p id="last-phone" class="ml-3 text-sm">{{ $last_user->contact_no ?? "Contact No." }}
                                </p>
                            </div>
                            <div class="flex items-center justify-between text-white">
                                <i class="fa-solid fa-calendar-days text-blue-300 text-2xl"></i>
                                <p id="last-date" class="ml-3 text-sm">
                                    {{ $last_user->created_at ?? "User Created Date" }}
                                </p>
                            </div>
                            <div class="flex items-center justify-between text-white">
            ...
            <div class="w-full xl:w-1/5 pl-3 pr-3 pt-4 flex flex-col">
                <div class="bg-gray-800 rounded-lg shadow-md flex-grow overflow-hidden flex flex-col">
                    <div class="flex items-center border-b border-gray-600 p-3 pl-6">
