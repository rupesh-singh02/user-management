    ...
    <div class="max-w-screen-xl m-0 sm:m-10 bg-gray-800 shadow sm:rounded-lg flex justify-center flex-1">
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            ...
            <div class="mt-12 flex flex-col items-center">
                <h1 class="text-2xl xl:text-3xl font-extrabold text-white">Sign up</h1>
                <div class="w-full flex-1 mt-8">
                    <div class="flex flex-col items-center">
                        <button
                            class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-600 text-gray-100 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
                        ...
                        <button
                            class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-600 text-gray-100 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                    ...
                    <div class="my-12 border-b text-center">
                        <div
                            class="leading-none px-2 inline-block text-sm text-gray-400 tracking-wide font-medium bg-gray-800 transform translate-y-1/2">
                    ...
                    <div class="mx-auto max-w-xs">
                        ...
                        <div class="mt-5">
                            <button x-data="{ loading: false }" :class="loading ? 'bg-indigo-700' : 'bg-indigo-500'"
                                :disabled="loading"
                                @click="loading = true; $wire.login().then(() => { loading = false; })"
                                ...
                                <template x-if="loading">
                                    <svg class="w-6 h-6 -ml-2 animate-spin" fill="none" stroke="currentColor"
