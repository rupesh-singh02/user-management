<div x-data="{ showModal: @entangle('showEditModal') }" x-show="showModal" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
    <div class="bg-gray-800 rounded-lg shadow-md w-96 py-3">
        ...
        <div class="mt-5 flex justify-end space-x-3 px-3 mb-2">
            <button @click="showModal = false" class="px-4 py-1 bg-gray-600 text-white rounded hover:bg-gray-700 text-sm">Cancel</button>
            <button wire:click="updateUser" class="px-4 py-1 bg-green-500 text-white rounded hover:bg-green-600 text-sm">Save</button>
        </div>
    </div>
</div>
